      ...
      <?php
       // header("Content-Type: text/html; charset=ISO-8859-1", true);
        ...
        if ($_GET["pag"]){
                ...
                header("Location:../Paginas/forumAluno.php?pag=1");
                }                      
                    $qtitenspag = 2;                    
...
<div class="container panel panel-default col-lg-8" > 
  ...
  <ul class="pagination pagination-lg">
    ...
    if ($pagatual > 1 ) {
         ?>
      <li>
      <a href="../Paginas/forumAluno.php?pag=<?php echo $pagatual -1;?>" aria-label="Previous">
 ...
 for ($i = 1; $i <= $qtpaginas; $i++) {
     ...
     if ($pagatual == $i){      
   ?>  
      <li class="active"><a href="../Paginas/forumAluno.php?pag=<?php echo "$i";?>"><?php echo "$i";?></a></li>
            <?php }  else {
 ?>
      <li><a href="../Paginas/forumAluno.php?pag=<?php echo "$i";?>"><?php echo "$i";?></a></li>
    
 <?php } }
    if ($pagatual != $qtpaginas ) {
         ?>
      <li>
      <a href="../Paginas/forumAluno.php?pag=<?php echo $pagatual +1;?>" aria-label="Next">
